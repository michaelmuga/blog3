...
class SlideTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $newslide1->filename = 'public/homeslides/aJQ2ts9BYcrVd8DZUJQlVsoGNM5LXDv3jbbRSSzp.jpeg';
        ...
        $newslide2->filename = 'public/homeslides/aJQ2ts9BYcrVd8DZUJQlVsoGNM5LXDv3jbbRSSzp.jpeg';
